...
export default function News() {
  ...
  return (
    <>
      ...
      <div id="news" className="w-full flex z-10 p-2 bg-gradient-to-r text-backgroundForeground  from-yellow-200 to-red-200 animate-fade text-secondaryLight font-Varela font-semibold items-center justify-around">

        {/* Important News Label */}
        <h1 className="bg-background rounded-lg p-3 text-xs sm:text-sm leading-none md:text-base animate-fade-in-left">Important News</h1>
