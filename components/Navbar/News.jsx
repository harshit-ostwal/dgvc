...
export default function News() {
  ...
  return (
    <>
      ...
      <div id="news" className="w-full flex z-10 p-2 bg-gradient-to-r from-yellow-200 to-red-200 animate-fade text-secondaryLight font-Varela font-semibold items-center justify-around">
